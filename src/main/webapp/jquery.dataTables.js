...
(/** @lends <global> */function(jQuery, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlTable ( oSettings )
		{
			...
			var nCaptions = jQuery(oSettings.nTable).children('caption');
		...
		function _fnScrollDraw ( o )
		{
			var
				...
				ie67 = jQuery.browser.msie && jQuery.browser.version <= 7;
		...
		function _fnExtend( oOut, oExtender )
		{
			for ( var prop in oOut )
			{
				...
				{
					if ( typeof oInit[prop] === 'object' && jQuery.isArray(oExtender[prop]) === false )
					{
						jQuery.extend( true, oOut[prop], oExtender[prop] );
					}
					else
					{
		...
		this.jQuery = function ( sSelector, oOpts )
		{
			...
			else if ( oOpts.order == "original" && oOpts.filter == "applied" )
			{
				for ( i=0, iLen=oSettings.aoData.length ; i<iLen ; i++ )
				{
					if ( jQuery.inArray( i, oSettings.aiDisplay ) !== -1 )
					{
						a.push( oSettings.aoData[ i ].nTr );
					}
				}
		 ...
		 *
		 * This method is often useful incombination with jQuery where both functions are given the
		...
		this.fnDestroy = function ( bRemove )
		{
			 ...
			 */
			jQuery(nBody).children('tr:even').addClass( oSettings.asDestroyStripes[0] );
			jQuery(nBody).children('tr:odd').addClass( oSettings.asDestroyStripes[1] );
		...
		this.fnUpdate = function( mData, mRow, iColumn, bRedraw, bAction )
		{
			...
			if ( oSettings.__fnUpdateDeep === undefined && jQuery.isArray(mData) && typeof mData === 'object' )
			{
		...
		return this.each(function() {
			...
			var anRows = jQuery(this).children('tbody').children('tr');
			...
			if ( bStripeRemove )
			{
				...
				if ( jQuery(anRows[0]).hasClass(oSettings.oClasses.sStripeOdd) )
				{
					oSettings.asDestroyStripes[0] += oSettings.oClasses.sStripeOdd+" ";
				}
				if ( jQuery(anRows[0]).hasClass(oSettings.oClasses.sStripeEven) )
				{
					oSettings.asDestroyStripes[0] += oSettings.oClasses.sStripeEven;
				}
				if ( jQuery(anRows[1]).hasClass(oSettings.oClasses.sStripeOdd) )
				{
					oSettings.asDestroyStripes[1] += oSettings.oClasses.sStripeOdd+" ";
				}
				if ( jQuery(anRows[1]).hasClass(oSettings.oClasses.sStripeEven) )
				{
